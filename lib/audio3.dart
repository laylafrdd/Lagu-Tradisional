...
class AudioPlayer3Screens extends StatefulWidget {
  @override
  _AudioPlayer3ScreensState createState() => _AudioPlayer3ScreensState();
}

class _AudioPlayer3ScreensState extends State<AudioPlayer3Screens> {
