...
class AudioPlayerScreens extends StatefulWidget {
  @override
  _AudioPlayerScreensState createState() => _AudioPlayerScreensState();
}

class _AudioPlayerScreensState extends State<AudioPlayerScreens> {
