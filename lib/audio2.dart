...
class AudioPlayer2Screens extends StatefulWidget {
  @override
  _AudioPlayer2ScreensState createState() => _AudioPlayer2ScreensState();
}

class _AudioPlayer2ScreensState extends State<AudioPlayer2Screens> {
